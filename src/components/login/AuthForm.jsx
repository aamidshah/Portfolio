...
//   const [formData, setFormData] = useState({ username: "", email: "", password: "" });
//   const [loading, setLoading] = useState(false);
//   const [contributors, setContributors] = useState(new Set()); // ✅ Store unique contributors

//   // ✅ Fetch all contributors from projects
//   useEffect(() => {
...
//         const allContributors = new Set(projects.flatMap((project) => project.contributors));
//         setContributors(allContributors); // ✅ Store unique contributor usernames
//       } catch (error) {
...
//     if (isSignUp) {
//       // ✅ Check if username exists in contributors list
//       if (!contributors.has(username)) {
//         toast.error("You are not authorized to register!", { position: "top-right" });
//         setLoading(false);
//         return;
//       }
//     }
...
//       if (!response || !response.success) {
//         throw new Error(response.error || "Enter valid credentials!");
//       }
